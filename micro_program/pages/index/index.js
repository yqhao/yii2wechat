var _hosts_api = 'http://www.wechat.dev';
...
//---------------------------------------------------------------------------------------------------
  getCarousel:function(){
    ...
    appInstance.sendRequest(
      {
        url: '/api/v1/carousels/1',
        complete: function (res) {
          //console.log('--------------complete--------------');
          //console.log(res.data);
          if (res.data){
            that.setData({ carousel1: res.data });
          }
        }
      },
      _hosts_api
