 ...
 * @property \yii\db\Connection $db_online The database connection. This property is read-only.
 * @property \yii\db\Connection $db_bi The database connection. This property is read-only.
